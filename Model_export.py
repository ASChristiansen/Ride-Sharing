...
# Decision variables
x = model.addVars(K, K + P, P + [d], vtype=GRB.BINARY, name="x")
q = model.addVars(P + K, vtype=GRB.INTEGER, name="q")
...
output_file = r"C:\Users\Amand\OneDrive\Dokumenter\Københavns Universitet\3. år\Bachelorprojekt\Optimization_results.xlsx"
